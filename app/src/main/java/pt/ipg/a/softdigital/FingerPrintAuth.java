...
public class FingerPrintAuth extends AppCompatActivity {
        ...
        FingerprintManager.AuthenticationCallback callback = new FingerprintManager.AuthenticationCallback() {
            ...
            public void onAuthenticationSucceeded(FingerprintManager.AuthenticationResult result) {
                updateText(getString(R.string.fingerPrint_sucess));
            }

            @Override
            public void onAuthenticationFailed() {
                updateText(getString(R.string.fingerPrint_failed));
            }
        };
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if (!fingerprintManager.isHardwareDetected()) {
                ...
                Toast.makeText(this, getString(R.string.fingerPrint_notsupport), Toast.LENGTH_LONG).show();
                return;
            }
            //Check whether the user has granted your app the USE_FINGERPRINT permission//
            if (ActivityCompat.checkSelfPermission(this, Manifest.permission.USE_FINGERPRINT) != PackageManager.PERMISSION_GRANTED) {
                // If your app doesn't have this permission, then display the following text//
                Toast.makeText(this, getString(R.string.fingerPrint_permissiondenied), Toast.LENGTH_LONG).show();
                return;
            }
            ...
            if (!fingerprintManager.hasEnrolledFingerprints()) {
                ...
                Toast.makeText(this, getString(R.string.fingerPrint_notconfigured), Toast.LENGTH_LONG).show();
                return;
            }
